    ...
    with app.app_context():
        try:
            ...
            registros_sin_clasificar = PokerResult.query.filter(
                PokerResult.categoria == 'Torneo',
                PokerResult.tipo_movimiento.in_(['Bounty',
    'Winnings',
    'Sit & Crush Jackpot',
    'Fee',
    'Reentry Fee',
...
def reclasificar_tipos_juego_automatica():
    ...
    with app.app_context():
        try:
            ...
            registros_sin_clasificar = PokerResult.query.filter(
                PokerResult.categoria == 'Torneo',
                PokerResult.tipo_movimiento.in_(
    [
        'Reentry Buy In',
        'Winnings',
        'Bounty',
...
def api_informes_opciones():
    ...
    with app.app_context():
        try:
            # Obtener opciones únicas para el usuario actual usando funciones auxiliares
            ...
            return jsonify({'success': False, 'error': f'Error al obtener opciones: {str(e)}'}), 500
...
def api_ultimos_10_dias():
    ...
    with app.app_context():
        try:
            ...
            return jsonify({'error': f'Error al obtener resultados de últimos 10 días: {str(e)}'}), 500
